...
- 2026-08-15 全ゲームUI監査を実施（レポート: `../_audit-2026-08-15/`）。
...
- 検証: `npm run build` 緑・iPhone13相当で全ページスクショ確認（`../_audit-2026-08-15/after/`）。
...
2. **うまうまレース と BACK10 の2本だけを単独サーバー（別URL）に分離する**（2026-08-15 決定）。
   ...
   手順とFirebaseの注意は `../_audit-2026-08-15/02-あそびばのサーバー構成.md` の「移行時の地雷」参照。
